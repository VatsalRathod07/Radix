...
const Global = () => {
    return (
        <section className="container mx-auto px-5 py-10">
            <div className="grid grid-cols-2 justify-items-center items-center gap-5 p-2">
                <div className="flex flex-col gap-5">
                    <h1 className="text-black text-4xl font-Oswald font-semibold">NOW WE ARE GLOBALY EVERYWHARE</h1>
