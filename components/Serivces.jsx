...
const Serivces = () => {
    return (
        <section className="container mx-auto pt-10 px-5">
            <div className="grid grid-cols-5 p-5 justify-items-center bg-[whitesmoke] rounded-md">
               {ServicesData.map((data) => {
                return (
                    <div className="flex flex-col gap-2 text-center items-center hover:bg-white p-3 w-full cursor-pointer rounded-lg transition duration-500 ease-in-out">
